...
@Sasibot.on_message(filters.command("start"))
async def start(client, message):
   if message.chat.type == 'private':
       await Sasibot.send_message(
               chat_id=message.chat.id,
               text="""<b>හායි යාලුවනේ ඔයාලට බාගතකරගන්න අවශ්‍ය කරන Youtube හෝ  Xhamster හෝ Pornhub වල ලින්ක් එක මට එවන්න.
			      මම ඉතා ඉක්මනින් ඔයාට අවශය හෝ ආකරයට අරගෙන දෙනවා,මාව පාවිච්චි කරන විදිය දන්නෙ නැත්නම් help button ඔබන්න,මාව හැදුවේ @MR_THANUWA උතුමානන් තමයි</b>""",   
                            reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
                                            "Help", callback_data="help"),
                                        InlineKeyboardButton(
                                            "Channel", url="https://t.me/smithbuildersofc")
                                    ],[
                                      InlineKeyboardButton(
                                            "Source Code", url="https://github.com/thanuwasmith/Sasi-Bot")
                                    ]]
                            ),        
            disable_web_page_preview=True,        
            parse_mode="html")

@Sasibot.on_message(filters.command("help"))
async def help(client, message):
    if message.chat.type == 'private':   
        await Sasibot.send_message(
               chat_id=message.chat.id,
               text="""<b>Sasi Bot Help!
...
@Sasibot.on_message(filters.command("about"))
async def about(client, message):
    if message.chat.type == 'private':   
        await Sasibot.send_message(
               chat_id=message.chat.id,
               text="""<b>About Sasi YTDL Bot!</b>

<b>♞ Developer:</b> <a href="https://t.me/MR_THANUWA">Jason</a>

<b>♞ Support:</b> <a href="https://t.me/smithbuildersofc">MR_THANUWA BOTs Support</a>

<b>♞ Library:</b> <a href="https://github.com/pyrogram/pyrogram">Pyrogram</a>

<b>Owner @MR_THANUWA</b>""",
     reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
...
@Sasibot.on_message(filters.private
                   & filters.text
                   & ~filters.edited
        ...
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=message.chat.id,
                    text="Sorry, You are Banned to use me. Contact my [Support Group](https://t.me/smithbuildersofc).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
            ...
            await c.send_message(
                chat_id=message.chat.id,
                text="Something went Wrong. Contact my [Support Group](https://t.me/smithbuildersofc).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
    await message.reply_text(
        "**තෝරන්න Download කරන්න ඕන විදිය👇**",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
@Sasibot.on_callback_query(filters.regex("^ytdl_audio$"))
...
@Sasibot.on_callback_query(filters.regex("^ytdl_video$"))
